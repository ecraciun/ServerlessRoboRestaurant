...
namespace Restaurant
{
    public static class DishOrchestrator
    {
            ...
            [OrchestrationTrigger] DurableOrchestrationContext context)
        {
            ...
            outputs.Add(await context.CallActivityAsync<string>("DishOrchestrator_Hello", "London"));

            // returns ["Hello Tokyo!", "Hello Seattle!", "Hello London!"]
            return outputs;
        }

        [FunctionName("DishOrchestrator_Hello")]
            ...
            ILogger log)
        {
            ...
            string instanceId = await starter.StartNewAsync("DishOrchestrator", null);
